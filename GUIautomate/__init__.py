# GUIautomate lets Python control the mouse and keyboard, and other GUI automation tasks. For Windows, macOS, and Linux,
# on Python 3 and 2.

# BJ SriBalaji sribalaji2112@gmail.com (Send me feedback & suggestions!)
# MIT license

# TODO - Follow https://github.com/SriBalajiSMVEC
# snapshot logging
...
class GUIautomateException(Exception):
    """
    GUIautomate code will raise this exception class for any invalid actions. If GUIautomate raises some other exception,
    you should assume that this is caused by a bug in GUIautomate itself. (Including a failure to catch potential
    exceptions raised by GUIautomate.)
    """

    pass


class Fail_safe_Exception(GUIautomateException):
    """
    This exception is raised by GUIautomate functions when the user puts the mouse cursor into one of the "failsafe
...
class ImgNotException(GUIautomateException):
    """
    This exception is the GUIautomate version of PyScreeze's `ImgNotException`, which is raised when a locate*()
    function call is unable to find an image.

    Ideally, `pyscreeze.ImgNotException` should never be raised by GUIautomate.
    """
...
try:
    ...
    def NotImportPyTweening(*unused_args, **unused_kwargs):
        """
        This function raises ``GUIautomateException``. It's used for the PyTweening function names if the PyTweening
        module failed to be imported.
        """
        raise GUIautomateException(
            "GUIautomate was unable to import pytweening. Please install this module to enable the function you tried to call."
        )

    easeInQuad = NotImportPyTweening
    easeOutQuad = NotImportPyTweening
    easeInOutQuad = NotImportPyTweening
    easeInCubic = NotImportPyTweening
    easeOutCubic = NotImportPyTweening
    easeInOutCubic = NotImportPyTweening
    easeInQuart = NotImportPyTweening
    easeOutQuart = NotImportPyTweening
    easeInOutQuart = NotImportPyTweening
    easeInQuint = NotImportPyTweening
    easeOutQuint = NotImportPyTweening
    easeInOutQuint = NotImportPyTweening
    easeInSine = NotImportPyTweening
    easeOutSine = NotImportPyTweening
    easeInOutSine = NotImportPyTweening
    easeInExpo = NotImportPyTweening
    easeOutExpo = NotImportPyTweening
    easeInOutExpo = NotImportPyTweening
    easeInCirc = NotImportPyTweening
    easeOutCirc = NotImportPyTweening
    easeInOutCirc = NotImportPyTweening
    easeInElastic = NotImportPyTweening
    easeOutElastic = NotImportPyTweening
    easeInOutElastic = NotImportPyTweening
    easeInBack = NotImportPyTweening
    easeOutBack = NotImportPyTweening
    easeInOutBack = NotImportPyTweening
    easeInBounce = NotImportPyTweening
    easeOutBounce = NotImportPyTweening
    easeInOutBounce = NotImportPyTweening
...
try:
    ...
    def NotImportPyMsgBox(*unused_args, **unused_kwargs):
        """
        This function raises ``GUIautomateException``. It's used for the PyMsgBox function names if the PyMsgbox module
        failed to be imported.
        """
        raise GUIautomateException(
            "GUIautomate was unable to import pymsgbox. Please install this module to enable the function you tried to call."
        )

    alert = confirm = prompt = password = NotImportPyMsgBox


def GUIautomateImgNotException(wrappedFunction):
    """
    A decorator that wraps PyScreeze locate*() functions so that the GUIautomate user sees them raise GUIautomate's
    ImgNotException rather than PyScreeze's ImgNotException. This is because PyScreeze should be
    invisible to GUIautomate users.
    """
    ...
    def wrap(*args, **kwargs):
        ...
        except pyscreeze.ImgNotException:
            raise ImgNotException  # Raise GUIautomate's ImgNotException.
...
try:
    ...
    # Change the locate*() functions so that they raise GUIautomate's ImgNotException instead.
    @GUIautomateImgNotException
    ...
    @GUIautomateImgNotException
    def locateAllon_Screen(*args, **kwargs):
        return pyscreeze.locateAllon_Screen(*args, **kwargs)

    locateAllon_Screen.__doc__ = pyscreeze.locateAllon_Screen.__doc__

    @GUIautomateImgNotException
    def locateCenteron_Screen(*args, **kwargs):
        return pyscreeze.locateCenteron_Screen(*args, **kwargs)

    locateCenteron_Screen.__doc__ = pyscreeze.locateCenteron_Screen.__doc__

    @GUIautomateImgNotException
    def locateon_Screen(*args, **kwargs):
        return pyscreeze.locateon_Screen(*args, **kwargs)

    locateon_Screen.__doc__ = pyscreeze.locateon_Screen.__doc__
    ...
    def _couldNotImportPyScreeze(*unused_args, **unsed_kwargs):
        """
        This function raises ``GUIautomateException``. It's used for the PyScreeze function names if the PyScreeze module
        failed to be imported.
        """
        raise GUIautomateException(
            "GUIautomate was unable to import pyscreeze. (This is likely because you're running a version of Python that Pillow (which pyscreeze depends on) doesn't support currently.) Please install this module to enable the function you tried to call."
        )
    ...
    locateAllon_Screen = _couldNotImportPyScreeze
    locateCenteron_Screen = _couldNotImportPyScreeze
    locateon_Screen = _couldNotImportPyScreeze
...
try:
    ...
    def mouseInfo():
        """
        This function raises GUIautomateException. It's used for the MouseInfo function names if the MouseInfo module
        failed to be imported.
        """
        raise GUIautomateException(
            "GUIautomate was unable to import mouseinfo. Please install this module to enable the function you tried to call."
        )


def useImgNotException(value=None):
    """
    When called with no arguments, GUIautomate will raise ImgNotException when the PyScreeze locate*() functions
    ...
    try:
        ...
        raise GUIautomateException("useImgNotException() ws called but pyscreeze isn't installed.")
...
if sys.platform == "win32":  # PyGetWindow currently only supports Windows.
    try:
        ...
        def _couldNotImportPyGetWindow(*unused_args, **unused_kwargs):
            """
            This function raises GUIautomateException. It's used for the PyGetWindow function names if the PyGetWindow
            module failed to be imported.
            """
            raise GUIautomateException(
                "GUIautomate was unable to import pygetwindow. Please install this module to enable the function you tried to call."
            )
...
if sys.platform.startswith("java"):
    # from . import _GUIautomate_java as platformModule
    raise NotImplementedError("Jython is not yet supported by GUIautomate.")
elif sys.platform == "darwin":
    from . import _GUIautomate_osx as platformModule
elif sys.platform == "win32":
    from . import _GUIautomate_win as platformModule
elif platform.system() == "Linux":
    from . import _GUIautomate_x11 as platformModule
else:
    raise NotImplementedError("Your platform (%s) is not supported by GUIautomate." % (platform.system()))
...
# This value affects mouse goTo, dragTo and key event duration.
# TODO: Find a dynamic way to let the system catch up instead of blocking with a magic number.
DARWIN_CATCH_UP_TIME = 0.01

# If the mouse is over a coordinate in FAILSAFE_POINTS and FAILSAFE is True, the Fail_safe_Exception is raised.
...
# If not None, GUIautomate deletes old screenshots when this limit has been reached:
...
def _genericGUIautomateChecks(wrappedFunction):
    """
...
def linear(n):
    ...
    if not 0.0 <= n <= 1.0:
        raise GUIautomateException("Argument must be between 0.0 and 1.0.")
    return n


def _handlePause(_pause):
    """
    A helper function for performing a pause at the end of a GUIautomate function based on some settings.
...
def _normalizeXYArgs(firstArg, secondArg):
    ...
    several GUIautomate functions. If ``firstArg`` and ``secondArg`` are both ``None``, returns the current mouse cursor
    position.
    ...
    if firstArg is None and secondArg is None:
        ...
        try:
            location = locateon_Screen(firstArg)
            # The following code only runs if pyscreeze.USE_IMAGE_NOT_FOUND_EXCEPTION is not set to True, meaning that
            # locateon_Screen() returns None if the image can't be found.
            if location is not None:
                return center(location)
            else:
                return None
        except pyscreeze.ImgNotException:
            raise ImgNotException

        return center(locateon_Screen(firstArg))
...
def _logScreenshot(logScreenshot, funcName, funcArgs, folder="."):
    """
    A helper function that creates a screenshot to act as a logging mechanism. When a GUIautomate function is called,
...
def on_Screen(x, y=None):
    ...
    Args:
      Either the arguments are two separate values, first arg for x and second
        ...
        Example: on_Screen(x, y) or on_Screen([x, y])
...
right mouse buttons respectively, in GUIautomate 1, 2, and 3 refer to the left,
...
def mouseDown(x=None, y=None, button=PRIMARY, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    Args:
      x (int, float, None, tuple, optional): The x position on the screen where the
        ...
        the screen with locateon_Screen() and click the center of.
    ...
    Raises:
      GUIautomateException: If button is not one of 'left', 'middle', 'right', 1, 2, or 3
    """
...
def click(
    ...
    string is an image filename that GUIautomate will attempt to locate on the screen and click the center of. If ``x``
    ...
    The ``pause`` parameter is deprecated. Call the ``GUIautomate.sleep()`` function to implement a pause.

    Raises:
      GUIautomateException: If button is not one of 'left', 'middle', 'right', 1, 2, 3
    """
...
def leftClick(x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    This is a wrap function for click('left', x, y).
...
def rightClick(x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    This is a wrap function for click('right', x, y).
...
def middleClick(x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    This is a wrap function for click('middle', x, y).
...
def doubleClick(x=None, y=None, interval=0.0, button=LEFT, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    This is a wrap function for click('left', x, y, 2, interval).
    ...
    Raises:
      GUIautomateException: If button is not one of 'left', 'middle', 'right', 1, 2, 3, 4,
        5, 6, or 7
    """
...
def tripleClick(x=None, y=None, interval=0.0, button=LEFT, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
    ...
    This is a wrap function for click('left', x, y, 3, interval).
...
@_genericGUIautomateChecks
def horizontalScroll(clicks, x=None, y=None, logScreenshot=None, _pause=True):
    ...
    _logScreenshot(logScreenshot, "horizontalScroll", "%s,%s,%s" % (clicks, x, y), folder=".")
    platformModule._horizontalScroll(clicks, x, y)


@_genericGUIautomateChecks
def verticalScroll(clicks, x=None, y=None, logScreenshot=None, _pause=True):
    ...
    _logScreenshot(logScreenshot, "verticalScroll", "%s,%s,%s" % (clicks, x, y), folder=".")
    platformModule._verticalScroll(clicks, x, y)


@_genericGUIautomateChecks
def goTo(x=None, y=None, duration=0.0, tween=linear, logScreenshot=False, _pause=True):
    ...
    _logScreenshot(logScreenshot, "goTo", "%s,%s" % (x, y), folder=".")
    _mouseMoveDrag("move", x, y, 0, 0, duration, tween)


@_genericGUIautomateChecks
def goRel(xOffset=None, yOffset=None, duration=0.0, tween=linear, logScreenshot=False, _pause=True):
    ...
    _logScreenshot(logScreenshot, "goRel", "%s,%s" % (xOffset, yOffset), folder=".")
    _mouseMoveDrag("move", None, None, xOffset, yOffset, duration, tween)


move = goRel  # For GUIautomate 1.0, move() replaces goRel().
...
drag = dragRel  # For GUIautomate 1.0, we want drag() to replace dragRel().
...
def _mouseMoveDrag(moveOrDrag, x, y, xOffset, yOffset, duration, tween=linear, button=None):
    ...
    handles both. Users should call the goTo() or dragTo() functions instead
    ...
    for tweenX, tweenY in steps:
        ...
        if moveOrDrag == "move":
            platformModule._goTo(tweenX, tweenY)
...
def isValidKey(key):
    ...
    GUIautomate's keyboard-related functions for the current platform.

    This function is here because passing an invalid value to the GUIautomate
...
def typewrite(message, interval=0.0, logScreenshot=None, _pause=True):
    ...
    keys, it cannot be used to perform keyboard shortcuts. Use the doubleKey()
    function for that.
...
write = typewrite  # In GUIautomate 1.0, write() replaces typewrite().


@_genericGUIautomateChecks
def doubleKey(*args, **kwargs):
    """Performs key down presses on the arguments passed in order, then performs
    key releases in reverse order.

    The effect is that calling doubleKey('ctrl', 'shift', 'c') would perform a
    "Ctrl-Shift-C" doubleKey/keyboard shortcut press.
    ...
    _logScreenshot(kwargs.get("logScreenshot"), "doubleKey", ",".join(args), folder=".")
    for c in args:
        if len(c) > 1:
            c = c.lower()
...
def failSafeCheck():
    if FAILSAFE and tuple(position()) in FAILSAFE_POINTS:
        raise Fail_safe_Exception(
            "GUIautomate fail-safe triggered from mouse moving to a corner of the screen. To disable this fail-safe, set GUIautomate.FAILSAFE to False. DISABLING FAIL-SAFE IS NOT RECOMMENDED."
        )
...
def displayMousePosition(xOffset=0, yOffset=0):
    ...
    try:
        while True:
            ...
            if not on_Screen(x - xOffset, y - yOffset) or sys.platform == "darwin":
...
def _getNumberToken(commandStr):
    ...
    if mo is None:
        raise GUIautomateException("Invalid command at index 0: a number was expected")
...
def _getQuotedStringToken(commandStr):
    ...
    mo = pattern.search(commandStr)
    if mo is None:
        raise GUIautomateException("Invalid command at index 0: a quoted string was expected")
...
def _getParensCommandStrToken(commandStr):
    ...
    mo = pattern.search(commandStr)
    if mo is None:
        raise GUIautomateException("Invalid command at index 0: No open parenthesis found.")
    ...
    while i < len(commandStr):
        if commandStr[i] == "(":
            ...
            if openParensCount == 0:
                ...
                raise GUIautomateException("Invalid command at index 0: No open parenthesis for this close parenthesis.")
        i += 1
    if openParensCount > 0:
        raise GUIautomateException("Invalid command at index 0: Not enough close parentheses.")
...
def _getCommaToken(commandStr):
    ...
    mo = pattern.search(commandStr)
    if mo is None:
        raise GUIautomateException("Invalid command at index 0: a comma was expected")
...
def _tokenizeCommandStr(commandStr):
    ...
    while i < len(commandStr):
        ...
        if mo is None:
            raise GUIautomateException("Invalid command at index %s: %s is not a valid command" % (i, commandStr[i]))
        ...
        # Handle the arguments of the mouse (g)o and mouse (d)rag commands:
            ...
            try:
            ...
            except GUIautomateException as excObj:
                ...
                raise GUIautomateException("Invalid command at index %s:%s" % (newIndexNum, message))

            # Make sure either both x and y have +/- or neither of them do:
            if x.lstrip()[0].isdecimal() and not y.lstrip()[0].isdecimal():
                raise GUIautomateException("Invalid command at index %s: Y has a +/- but X does not." % (i - len(y)))
    ...
    while i < len(commandList):
        ...
        if command == "c":
            ...
            if commandList[i + 1][0] in ("+", "-") and commandList[i + 2][0] in ("+", "-"):
                ...
                goTo(int(commandList[i + 1]), int(commandList[i + 2]))
            i += 2
        elif command == "d":
            if commandList[i + 1][0] in ("+", "-") and commandList[i + 2][0] in ("+", "-"):
            ...
            doubleKey(*commandList[i + 1].replace(" ", "").split(","))
            i += 1
        elif command == "a":
...
def run(commandStr, _ssCount=None):
    """Run a series of GUIautomate function calls according to a mini-language
    made for this function. The `commandStr` is composed of character
    commands that represent GUIautomate function calls.
    ...
    `gX,Y` => `goTo(X, Y)`
    `g+X,-Y` => `move(X, Y) # The + or - prefix is the difference between move() and goTo()`
    `dX,Y` => `dragTo(X, Y)`
    `d+X,-Y` => `drag(X, Y) # The + or - prefix is the difference between drag() and dragTo()`

    `k'key'` => `press('key')`
    `w'text'` => `write('text')`
    `h'key,key,key'` => `doubleKey(*'key,key,key'.replace(' ', '').split(','))`
    `a'hello'` => `alert('hello')`
