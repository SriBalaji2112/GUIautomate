...
with open('GUIautomate/__init__.py', 'r') as fd:
...
setup(
    name='GUIautomate',
    version=version,
    url='https://github.com/SriBalajiSMVEC/GUIautomate',
    author='BalajiSanthanam',
    author_email='sribalaji2112@gmail.com',
    description=('GUIautomate lets Python control the mouse and keyboard, and other GUI automation tasks. For Windows, macOS, and Linux, on Python 3 and 2.'),
    long_description=long_description,
    long_description_content_type="text/markdown",
    license='MIT',
    packages=['GUIautomate'],
    test_suite='tests',
