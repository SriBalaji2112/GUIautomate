# Windows implementation of GUIautomate functions.
# MIT license
...
import GUIautomate
from GUIautomate import LEFT, MIDDLE, RIGHT

import sys
if sys.platform !=  'win32':
    raise Exception('The GUIautomate_win module should only be loaded on a Windows system.')


# Fixes the scaling issues where GUIautomate was reporting the wrong resolution:
try:
...
""" Keyboard key mapping for GUIautomate:
Documented at http://msdn.microsoft.com/en-us/library/windows/desktop/dd375731(v=vs.85).aspx

The *KB dictionaries in GUIautomate map a string that can be passed to keyDown(),
keyUp(), or press() into the code used for the OS-specific keyboard function.

They should always be lowercase, and the same keys should be used across all OSes."""
keyboardMapping = dict([(key, None) for key in GUIautomate.KEY_NAMES])
...
def _keyDown(key):
    ...
    needsShift = GUIautomate.isShiftCharacter(key)
...
def _moveTo(x, y):
    ...
    # This was a possible solution to issue #314 https://github.com/asweigart/GUIautomate/issues/314
...
def _mouseDown(x, y, button):
    ...
    try:
        ...
        # TODO: We need to figure out how to prevent these errors, see https://github.com/asweigart/GUIautomate/issues/60
        pass
...
def _mouseUp(x, y, button):
    ...
    try:
        _sendMouseEvent(EV, x, y)
    except (PermissionError, OSError): # TODO: We need to figure out how to prevent these errors, see https://github.com/asweigart/GUIautomate/issues/60
        pass
...
def _sendMouseEvent(ev, x, y, dwData=0):
    ...
    # TODO: Too many false positives with this code: See: https://github.com/asweigart/GUIautomate/issues/108
